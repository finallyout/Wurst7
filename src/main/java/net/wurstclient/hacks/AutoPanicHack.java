...
public final class AutoPanicHack extends Hack implements UpdateListener
{
	...
	private final CheckboxSetting dontPanicNearFriendsCheckbox = new CheckboxSetting(
		"Don't auto panic near friends",
	...
	public void onUpdate()
	{
		...
		dontPanicNearFriends = dontPanicNearFriendsCheckbox.getValue()
		...
		stream = stream.filter(e -> MC.player.squaredDistanceTo(e) <= detectionRangeSq)
